...
function Card(props) {
  return (
    <li className="group overflow-hidden rounded-xl bg-white p-4 shadow-md ring-1 ring-black/5 transition hover:-translate-y-px hover:shadow-lg not-[:has(img,h2)]:text-2xl has-[img]:p-0">
